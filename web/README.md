...
the current output update ratio plus an EMA. The same query knobs used by the
Bevy app are available, including `visualization-mode`, `keyframe-duration`,
`show-fps`, and `show-gaze-ratio`.
